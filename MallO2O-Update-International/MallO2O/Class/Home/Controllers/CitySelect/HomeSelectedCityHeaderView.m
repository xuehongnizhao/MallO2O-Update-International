...
- (UILabel *)homeSelectedCityTitleView {
    ...
    if (!_homeSelectedCityTitleView) {
        ...
        _homeSelectedCityTitleView.font = [UIFont systemFontOfSize:17];
...
- (UIButton *)homeSelectedCityDescView {
    ...
    if (!_homeSelectedCityDescView) {
        ...
        [_homeSelectedCityDescView settingSubmitButton:_homeSelectedCityDescView backgroundColor:[UIColor blackColor] setTitle:@"" fontSize:16 fontColor:[UIColor grayColor] target:self action:@selector(clickButton:) buttonTag:0];
