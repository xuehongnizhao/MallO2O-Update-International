...
- (void)settingAutoLayout{
    ...
    _secondTimeLabel.textColor = UIColorFromRGB(0xaeaeae);
...
+ (instancetype)secondeCellWithTableView:(UITableView *)tableView cellForRowAtIndex:(NSIndexPath *)index{
    ...
    if (!cell) {
        cell = [[SearchResultTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
...
- (void)setData{
    ...
    _secondNowPriceLabel.text = [@"￥" stringByAppendingFormat:@"%@元",_secondModel.secondNowPriceText];
