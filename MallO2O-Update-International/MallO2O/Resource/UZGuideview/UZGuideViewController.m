...
- (void)viewDidLoad
{
    ...
    NSArray *imageNameArray = [NSArray arrayWithObjects:welcomePage1,welcomePage2,welcomePage3,nil];
    ...
    for (int i = 0; i < imageNameArray.count; i++) {
        ...
        if (i == imageNameArray.count - 1) {
            ...
            [enterButton setTitleColor:[UIColor blackColor]
                              forState:UIControlStateNormal];
            [enterButton setTitleColor:[UIColor blackColor]
            ...
            if (IPHONE5) {
                [enterButton setCenter:CGPointMake(self.view.center.x, 25.f)];
            }else{
                [enterButton setCenter:CGPointMake(self.view.center.x, 25.f)];
            }
