...
//    self.tag = [model.cat_id intValue];
    ...
    [self addSubview:image];
    [image autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:15.0f*Balance_Heith];
    [image autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:15.0f*Balance_Heith];
    [image autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:10.0f];
    [image autoSetDimension:ALDimensionWidth toSize:30.0f*Balance_Heith];
    [image sd_setImageWithURL:[NSURL URLWithString:model.cat_img] placeholderImage:[UIImage imageNamed:@"user"]];
    //主标题
    ...
    indexTitles.text = model.cat_name;
    indexTitles.textColor = [self colorWithHexString:color];
    indexTitles.font = [UIFont systemFontOfSize:18.0*Balance_Heith];
    ...
    [indexTitles autoSetDimension:ALDimensionHeight toSize:18.0f*Balance_Heith];
    //副标题
    UILabel *subTitle = [[UILabel alloc] initForAutoLayout];
    [self addSubview:subTitle];
    subTitle.text = model.cat_subHead;
    subTitle.font = [UIFont systemFontOfSize:12.0*Balance_Heith];
    ...
    [subTitle autoSetDimension:ALDimensionHeight toSize:11.0f*Balance_Heith];
