...
@interface GroupSearchViewController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>
...
-(void)initDataSourceAndOther
{
    ...
    [historyArray addObjectsFromArray:[[NSUserDefaults standardUserDefaults] objectForKey:@"group_history"]];
    //判断是否显示的历史记录
    isShowHistory=YES;
...
-(void)searchPost
{
    ...
    if (![_searchBar.text isEqualToString:@""])
    {
        ...
        [[NSUserDefaults standardUserDefaults] setObject:historyArray forKey:@"group_history"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        static NSString *simpleTableIdentifier=@"search_group_cell";
