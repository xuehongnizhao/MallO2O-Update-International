//
//  orderRoomSearchViewController.m
//  CardLeap
//
...
@interface orderRoomSearchViewController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UISearchBar* searchBar;
@property (strong, nonatomic) UITableView *LinGroupTableView;

@end

@implementation orderRoomSearchViewController
{
    //当前页数
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        static NSString *simpleTableIdentifier=@"search_room_cell";
        ...
        orderRoomInfo *info = [postDataSourceArray objectAtIndex:indexPath.row];
