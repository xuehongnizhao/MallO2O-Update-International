...
@interface sumitSuccessViewController ()
...
@implementation sumitSuccessViewController
...
-(void)setUI
{
    ...
    [_backShopButton autoSetDimension:ALDimensionWidth toSize:120.0f*Balance_Width];
    ...
    [_checkOrderButton autoSetDimension:ALDimensionWidth toSize:120.0f*Balance_Width];
...
-(UIButton *)backShopButton
{
    if (!_backShopButton) {
        ...
        [_backShopButton setTitle:@"返回商家" forState:UIControlStateNormal];
        [_backShopButton setTitle:@"返回商家" forState:UIControlStateHighlighted];
